...
export interface WaitForCaddyReadyOptions {
  baseUrl?: string
  timeoutMs?: number
  intervalMs?: number
...
export async function waitForCaddyReady(opts: WaitForCaddyReadyOptions = {}): Promise<void> {
...
function probe(baseUrl: string, timeoutMs: number): Promise<boolean> {
