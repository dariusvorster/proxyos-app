...
gap: 9px;
```
Contents: mark (26×26) + "ProxyOS" (Inter 500 14px) + version badge.
...
**Nav icons:** 15×15px, `color: var(--text3)`. Active: `color: var(--accent)`.
...
Left: page title (Inter 600 15px, `var(--text)`)
